const Skeleton = () => {
  return (
    <div className="flex space-x-3 p-5 bg-white border-l-4 border-gray-500 mt-4" aria-live="assertive" aria-atomic="true">
      <div className="flex-none w-8 h-8 bg-gray-200 rounded-full animate-pulse"/>
